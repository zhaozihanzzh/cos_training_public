...
#[cfg(feature = "sv48")]
#[link_section = ".data.boot_page_table"]
static mut BOOT_PTL3_SV48: [u64; 512] = [0; 512];
#[cfg(feature = "sv48")]
#[link_section = ".data.boot_page_table"]
static mut BOOT_PTL4_SV48: [u64; 512] = [0; 512];
#[cfg(feature = "sv39")]
...
#[cfg(feature = "sv48")]
pub unsafe fn pre_mmu() {
    BOOT_PTL3_SV48[2] = (0x80000 << 10) | 0xef;//((BOOT_PTL2_SV48.as_ptr() as u64) >> 12 << 10) | 0x01;
    BOOT_PTL3_SV48[0x102] = (0x80000 << 10) | 0xef;//((BOOT_PTL2_SV48.as_ptr() as u64) >> 12 << 10) | 0x01;
    BOOT_PTL3_SV48[0x1ff] = (0x80000 << 10) | 0xef;// ((BOOT_PTL2_SV48.as_ptr() as u64) >> 12 << 10) | 0x01;

    BOOT_PTL4_SV48[0] = ((BOOT_PTL3_SV48.as_ptr() as u64) >> 12 << 10) | 0x01; // 似乎是跳板？
    BOOT_PTL4_SV48[0x1ff] = ((BOOT_PTL3_SV48.as_ptr() as u64) >> 12 << 10) | 0x01; // e3 is ok // 从 KERNEL_BASE 开始
    // ffff_ffff_c000_0000 -> 0000_0000_8000_0000 内核在物理地址 0x80200000
}
#[cfg(feature = "sv39")]
...
pub unsafe fn enable_mmu() {
    if cfg!(feature = "sv48") {
        let page_table_root = BOOT_PTL4_SV48.as_ptr() as usize;
